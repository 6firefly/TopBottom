<DIV id="topcontrol"><DIV class="backtotop" <?php echo ( ($this->opacity >0 && $this->opacity <= 1) ? '' : 'style="display:none;"'); ?>></DIV><DIV class="backtobottom" <?php echo ( ($this->opacity >0 && $this->opacity <= 1) ? '' : 'style="display:none;"'); ?>></DIV></DIV><?php
